...
const SELECT_JOIN = 'SELECT tw.id, tw.text, tw.createAt, tw.userId, us.username, us.name, us.email, us.url from tweets as tw JOIN users as us ON tw.userId = us.id';
